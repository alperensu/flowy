...
export default function MobilePlayer({ isOpen, onClose }) {
    ...
    return (
        <div
            className={`fixed inset-0 z-[60] bg-black/95 backdrop-blur-3xl flex flex-col transition-transform duration-500 ease-in-out ${isOpen ? 'translate-y-0' : 'translate-y-[100%]'}`}
